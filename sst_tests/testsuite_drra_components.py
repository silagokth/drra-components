...
class testcase_drra(SSTTestCase):
    ...
    # test_example0_drra_template was removed with the iosram resources it
    # drove. Its refFiles were last regenerated in March 2025 and encode the
    # pre-2026 instruction layout (2-bit opcode, dsu rather than evt), so it
    # had stopped matching the ISA long before the resources went. The same
    # ground is covered end to end, on io, by the drra-tests suite.
