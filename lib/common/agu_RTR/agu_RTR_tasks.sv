package agu_RTR_tasks;
  ...
  task automatic evaluate_MT_state(
      input int NUMBER_MT, input logic [$clog2(NUMBER_MT+1)-1:0] level_MT,
      input logic co_delay_MT[NUMBER_MT], output logic en_delay_MT[NUMBER_MT],
      output logic en_level_MT, output state_t n_state);
  ...
  task automatic evaluate_OR_state(
      input int NUMBER_OR, input logic co_iter_OR[NUMBER_OR], input logic co_delay_OR[NUMBER_OR],
  ...
  task automatic evaluate_IR_state(
      input int NUMBER_MT, input int NUMBER_OR, input int NUMBER_IR,
      input logic co_delay_MT[NUMBER_MT], output logic en_delay_MT[NUMBER_MT],
      inout logic regMT_config[NUMBER_MT], output logic init0_level_MT, output logic en_level_MT,
      input logic co_iter_OR[NUMBER_OR], input logic co_delay_OR[NUMBER_OR],
      input logic regOR_config[NUMBER_OR], output logic en_level_OR,
      output logic [$clog2(NUMBER_OR)-1:0] inVal_level_OR, output logic en_initVal_OR[NUMBER_OR],
      output logic en_delay_OR[NUMBER_OR], output logic en_flag_OR,
      input logic [$clog2(NUMBER_MT+1)-1:0] level_MT, input logic co_iter_IR[NUMBER_IR],
      input logic co_delay_IR[NUMBER_IR], input logic regIR_config[(NUMBER_MT+1)*NUMBER_IR],
      output logic en_level_IR, output logic [$clog2(NUMBER_IR)-1:0] inVal_level_IR,
      output logic en_initVal_IR[1:NUMBER_IR-1], output logic en_delay_IR[NUMBER_IR],
      output logic init_delay_IR[NUMBER_IR], output state_t n_state);
    n_state = IDLE;
