            ...
            GENR_IR0: begin
                ...
                if (!co_iter_IR[0] && !co_delay_IR[0]) begin
                    ...
                    if (!co_iter_IR[1] && !co_delay_IR[1]) begin
                        ...
                        if (!co_iter_IR[2] && !co_delay_IR[2]) begin
                            ...
                            if (!co_iter_OR[level_OR] && !co_delay_OR[level_OR]) begin
                                ...
                                $display("----- first loop :%0d, %0b, %0b", level_OR, co_iter_OR[level_OR], co_delay_OR[level_OR]);
                                n_state = GENR_OR;
                                en_initVal_OR[level_OR] = 1'b1;
                            end else begin
                                $display("----- second loop :%0d, %0b, %0b", level_OR, co_iter_OR[level_OR], co_delay_OR[level_OR]);
                                n_state = GENR_OR;
                                en_level_OR = 1'b1;
                       ...
                       if (!co_delay_MT[level_MT]) begin
                        ...
                        if (!co_iter_OR[level_OR] && !co_delay_OR[level_OR]) begin
                            ...
                            $display("----- third loop :%0d, %0b, %0b", level_OR, co_iter_OR[level_OR], co_delay_OR[level_OR]);
                            n_state = GENR_OR;
                            en_initVal_OR[level_OR] = 1'b1;
                        end else begin
                            $display("----- forth loop :%0d, %0b, %0b", level_OR, co_iter_OR[level_OR], co_delay_OR[level_OR]);
                            n_state = GENR_OR;
                            en_level_OR = 1'b1;
                            en_initVal_OR[level_OR + 1] = 1'b1;
                        end
                    ...
                    if (!co_iter_OR[level_OR] && !co_delay_OR[level_OR]) begin
                        ...
                        $display("----- fifth loop :%0d, %0b, %0b", level_OR, co_iter_OR[level_OR], co_delay_OR[level_OR]);
                        n_state = GENR_OR;
                        en_initVal_OR[level_OR] = 1'b1;
                    end else begin
                        $display("----- sixth loop :%0d, %0b, %0b", level_OR, co_iter_OR[level_OR], co_delay_OR[level_OR]);
                        n_state = GENR_OR;
                        en_level_OR = 1'b1;
                        en_initVal_OR[level_OR + 1] = 1'b1;
                    end
