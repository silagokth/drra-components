...
public:
  ...
  SST_ELI_REGISTER_COMPONENT(Dpu_q88, "drra", "dpu_q88",
                             SST_ELI_ELEMENT_VERSION(1, 0, 0), "Dpu Q88 component",
  ...
  void handleEVT(const DPU_Q88_PKG::EVTInstruction &instr);
  void handleREP(const DPU_Q88_PKG::REPInstruction &instr);
  void handleREPX(const DPU_Q88_PKG::REPXInstruction &instr);
  void handleTRANS(const DPU_Q88_PKG::TRANSInstruction &instr);
