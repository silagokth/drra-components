...
private:
  enum EVT_RELATIVE_PORT {
    EVT_PORT_SRAM_READ_FROM_IO = IOSRAM_BTM_PKG::EVT_PORT_INPUT_BUFFER,
    EVT_PORT_SRAM_WRITE_TO_IO = IOSRAM_BTM_PKG::EVT_PORT_OUTPUT_BUFFER,
    EVT_PORT_IO_WRITE_TO_SRAM = IOSRAM_BTM_PKG::EVT_PORT_SRAM_WRITE,
    EVT_PORT_IO_READ_FROM_SRAM = IOSRAM_BTM_PKG::EVT_PORT_SRAM_READ,
