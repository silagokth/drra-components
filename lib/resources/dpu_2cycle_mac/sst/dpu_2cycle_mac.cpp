...
void DPU2CycleMac::handleEventWithSlotID(SST::Event *event, uint32_t slot_id) {
...
void DPU2CycleMac::decodeInstr(uint32_t instr) {
...
void DPU2CycleMac::handleRep(uint32_t instr) {
  // Instruction fields
...
void DPU2CycleMac::handleRepx(uint32_t instr) { handleRep(instr); }

void DPU2CycleMac::handleFSM(uint32_t instr) {
  // Instruction fields
...
void DPU2CycleMac::handleDPU(uint32_t instr) {
...
void DPU2CycleMac::handleOperation(
