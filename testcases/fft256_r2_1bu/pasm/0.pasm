epoch <fft256_1BU> {
    ...
    cell (x=1, y=0) {
        ...
        rop <write_twid> (slot=3, port=2){
            ...
            rep (slot=3, port=2, iter=15, step=1, delay=0)
        }
        ...
        rop <read_d1> (slot=1, port=1){
            fft (slot=1, port=1, n_points=256, radix=0, n_bu=0, mode=1, delay=0)
        }

        rop <read_d2> (slot=2, port=1){
            fft (slot=2, port=1,  n_points=256, radix=0, n_bu=0, mode=1, delay=0)
        }

        rop <read_twid> (slot=3, port=1){
            fft (slot=3, port=1,  n_points=256, radix=0, n_bu=0, mode=0, delay=0)
        }

        rop <write_d1> (slot=1, port=0){
            fft (slot=1, port=0,  n_points=256, radix=0, n_bu=0, mode=1, delay=0)
        }

        rop <write_d2> (slot=2, port=0){
            fft (slot=2, port=0,  n_points=256, radix=0, n_bu=0, mode=1, delay=0)
        }
